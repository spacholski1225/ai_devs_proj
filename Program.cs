...
class Program
{
    private static readonly string baseUrl = "https://xyz.ag3nts.org/";
    ...
    static async Task Main(string[] args)
    {
        ...
        await Login(httpClient, loginEndpoint, username, password, answer);
    }
    ...
    private static async Task Login(HttpClient httpClient, string loginEndpoint, string username, string password, string answer)
    {
